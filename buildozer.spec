...
package.domain = com.paurush

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,ico,mp3,wav,ogg,ttf
...
requirements = python3==3.11.0,pygame==2.1.0
...
android.icon = resources/icon.png
android.presplash = resources/splash.png
